...
export const groupsApiClient = {
    ...
    getGroupDetails: (groupSlug: string, params: URLSearchParams | undefined) =>
        axios.get(`/api/GroupDetails/${groupSlug}`, { params }).then(axiosResponseBody),
    getSimilarGroups: (groupSlug: string, params: URLSearchParams | undefined) =>
        axios.get(`/api/GroupDetails/${groupSlug}/similar`, { params }).then(axiosResponseBody),
    getGroupMembers: (groupSlug: string) =>
        axios.get(`/api/GroupDetails/${groupSlug}/members`).then(axiosResponseBody),
    ...
    // Join/leave group as loggedin user
    joinGroup: (groupId: string) =>
        axios.post(`/api/Groups/${groupId}/join`).then(axiosResponseBody),
    leaveGroup: (groupId: string) =>
        axios.post(`/api/Groups/${groupId}/leave`).then(axiosResponseBody),
