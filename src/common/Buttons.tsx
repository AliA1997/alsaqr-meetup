...
export const CommonUpsertButton = React.memo(function ({ children, onClick, disabled, submitting, classNames, testId }: React.PropsWithChildren<CommonUpsertButtonProps>) {
    return (
        <button
            data-testid={testId ?? "boxbutton"}
            disabled={disabled}
            onClick={onClick}
            className={`
                rounded-full bg-[#55a8c2] px-5 py-2
                text-sm lg:text-lg font-bold text-white cursor-pointer
                disabled:opacity-40
